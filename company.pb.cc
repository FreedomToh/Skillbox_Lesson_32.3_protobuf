...
const uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Company, founded_),
  PROTOBUF_FIELD_OFFSET(::Company, legal_address_),
  PROTOBUF_FIELD_OFFSET(::Company, industry_),
  PROTOBUF_FIELD_OFFSET(::Company, foreign_trading_),
  0,
  3,
  1,
  2,
...
const char descriptor_table_protodef_company_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rcompany.proto\"j\n\007Company\022\014\n\004name\030\001 \002(\t"
  "\022\017\n\007founded\030\002 \002(\005\022\025\n\rlegal_address\030\003 \002(\t"
  "\022\020\n\010industry\030\004 \001(\t\022\027\n\017foreign_trading\030\005 "
  "\001(\010"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_company_2eproto = {
  false, false, 123, descriptor_table_protodef_company_2eproto, "company.proto", 
...
class Company::_Internal {
 public:
  ...
  static void set_has_foreign_trading(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Company::Company(const Company& from)
  ...
  ::memcpy(&founded_, &from.founded_,
    static_cast<size_t>(reinterpret_cast<char*>(&foreign_trading_) -
    reinterpret_cast<char*>(&founded_)) + sizeof(foreign_trading_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&founded_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&foreign_trading_) -
    reinterpret_cast<char*>(&founded_)) + sizeof(foreign_trading_));
}
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&founded_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&foreign_trading_) -
        reinterpret_cast<char*>(&founded_)) + sizeof(foreign_trading_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          founded_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Company.industry");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_foreign_trading(&has_bits);
          foreign_trading_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->_internal_founded(), target);
  }
  ...
  if (cached_has_bits & 0x00000002u) {
    ...
    target = stream->WriteStringMaybeAliased(
        3, this->_internal_legal_address(), target);
  }
  ...
  if (cached_has_bits & 0x00000004u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      "Company.industry");
    target = stream->WriteStringMaybeAliased(
        4, this->_internal_industry(), target);
  }

  // optional bool foreign_trading = 5;
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5, this->_internal_foreign_trading(), target);
  }
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:Company)
  ...
  if (_internal_has_founded()) {
    // required int32 founded = 2;
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_founded());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Company)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      founded_ = from.founded_;
    }
    if (cached_has_bits & 0x00000010u) {
      foreign_trading_ = from.foreign_trading_;
    }
...
void Company::InternalSwap(Company* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, foreign_trading_)
      + sizeof(Company::foreign_trading_)
      - PROTOBUF_FIELD_OFFSET(Company, founded_)>(
          reinterpret_cast<char*>(&founded_),
          reinterpret_cast<char*>(&other->founded_));
}
