...
class Company final :
 ...
 public:
  ...
  enum : int {
    ...
    kFoundedFieldNumber = 2,
    kForeignTradingFieldNumber = 5,
  };
  ...
  // required int32 founded = 2;
  bool has_founded() const;
  private:
  bool _internal_has_founded() const;
  public:
  void clear_founded();
  ...
  // optional bool foreign_trading = 5;
  bool has_foreign_trading() const;
  private:
  bool _internal_has_foreign_trading() const;
  public:
  void clear_foreign_trading();
  bool foreign_trading() const;
  void set_foreign_trading(bool value);
  private:
  bool _internal_foreign_trading() const;
  void _internal_set_foreign_trading(bool value);
  public:
...
// required int32 founded = 2;
inline bool Company::_internal_has_founded() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool Company::has_founded() const {
  return _internal_has_founded();
}
inline void Company::clear_founded() {
  founded_ = 0;
  _has_bits_[0] &= ~0x00000008u;
}
inline int32_t Company::_internal_founded() const {
  return founded_;
}
inline int32_t Company::founded() const {
  // @@protoc_insertion_point(field_get:Company.founded)
  return _internal_founded();
}
inline void Company::_internal_set_founded(int32_t value) {
  _has_bits_[0] |= 0x00000008u;
  founded_ = value;
}
inline void Company::set_founded(int32_t value) {
  _internal_set_founded(value);
  // @@protoc_insertion_point(field_set:Company.founded)
}
...
// optional string industry = 4;
inline bool Company::_internal_has_industry() const {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Company::set_industry(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
...
inline std::string* Company::mutable_industry() {
...
inline void Company::set_allocated_industry(std::string* industry) {
  if (industry != nullptr) {
    _has_bits_[0] |= 0x00000004u;
  } else {
    _has_bits_[0] &= ~0x00000004u;
...
// optional bool foreign_trading = 5;
inline bool Company::_internal_has_foreign_trading() const {
  bool value = (_has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool Company::has_foreign_trading() const {
  return _internal_has_foreign_trading();
}
inline void Company::clear_foreign_trading() {
  foreign_trading_ = false;
  _has_bits_[0] &= ~0x00000010u;
}
inline bool Company::_internal_foreign_trading() const {
  return foreign_trading_;
}
inline bool Company::foreign_trading() const {
  // @@protoc_insertion_point(field_get:Company.foreign_trading)
  return _internal_foreign_trading();
}
inline void Company::_internal_set_foreign_trading(bool value) {
  _has_bits_[0] |= 0x00000010u;
  foreign_trading_ = value;
}
inline void Company::set_foreign_trading(bool value) {
  _internal_set_foreign_trading(value);
  // @@protoc_insertion_point(field_set:Company.foreign_trading)
}
